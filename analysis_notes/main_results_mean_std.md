...
## Missing or Invalid Logs

| Dataset | Method | Seed | Error |
|---|---|---:|---|
| Caltech101 | BadCLIP | 1 | MISSING: analysis_notes/caltech101_shot2_seed1_ep10_badclip_train_seen.run.log; MISSING: analysis_notes/caltech101_shot2_seed1_ep10_badclip_test_unseen.run.log |
| Caltech101 | BadCLIP | 2 | MISSING: analysis_notes/caltech101_shot2_seed2_ep10_badclip_train_seen.run.log; MISSING: analysis_notes/caltech101_shot2_seed2_ep10_badclip_test_unseen.run.log |
| Caltech101 | BadCLIP | 3 | MISSING: analysis_notes/caltech101_shot2_seed3_ep10_badclip_train_seen.run.log; MISSING: analysis_notes/caltech101_shot2_seed3_ep10_badclip_test_unseen.run.log |
