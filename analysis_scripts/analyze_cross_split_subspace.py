...
base_path = "analysis_notes/badclip_alignment_base_full.npz"
new_path = "analysis_notes/badclip_alignment_new_full.npz"
out_path = "analysis_notes/cross_split_subspace.summary.txt"
