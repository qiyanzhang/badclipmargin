...
def main():
    ...
    basis_np = {
        ...
        "remove_pca3": pca3_b,
        "remove_pca5": pca5_b,
        "remove_pca10": pca10_b,
        "remove_mean_pca1": combine_basis(mean_b, pca1_b),
        "remove_mean_pca3": combine_basis(mean_b, pca3_b),
        "remove_mean_pca5": combine_basis(mean_b, pca5_b),
        "remove_mean_pca10": combine_basis(mean_b, pca10_b),
